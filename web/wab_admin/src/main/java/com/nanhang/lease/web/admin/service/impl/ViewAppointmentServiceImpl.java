...
import com.nanhang.lease.web.admin.mapper.ViewAppointmentMapper;
...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Override
    public IPage<AppointmentVo> selectIPage(Page<AppointmentVo> appointmentVoPage, AppointmentQueryVo queryVo) {


        return viewAppointmentMapper.selectIpage(appointmentVoPage,queryVo);
    }
}
